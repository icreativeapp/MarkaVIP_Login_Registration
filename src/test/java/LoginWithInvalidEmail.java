...
public class LoginWithInvalidEmail implements SauceOnDemandSessionIdProvider, SauceOnDemandAuthenticationProvider {
...
@Parameters({"username", "key", "os", "browser", "browserVersion"})
 ...
 DesiredCapabilities desiredCapabilities = new DesiredCapabilities();
	...
	driver.findElement(By.id("login_email")).sendKeys("icreativeapp@gmail");
	driver.findElement(By.id("pass")).sendKeys("147852");
	driver.findElement(By.id("login-send")).click();
	String invalidemail="Please enter a valid email address. For example johndoe@domain.com.";
	driver.findElement(By.id("advice-validate-email-login_email")).getText();
	Assert.assertEquals(driver.findElement(By.id("advice-validate-email-login_email")).getText(), invalidemail);
