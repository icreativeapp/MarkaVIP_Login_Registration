...
public class LoginWithValidAccount implements SauceOnDemandSessionIdProvider, SauceOnDemandAuthenticationProvider {
...
@Parameters({"username", "key", "os", "browser", "browserVersion"})
 ...
 DesiredCapabilities desiredCapabilities = new DesiredCapabilities();
    ...
    @Test
    public void Login_With_Valid_Account() throws Exception {
