...
public class RegisterWithExistingEmail implements SauceOnDemandSessionIdProvider, SauceOnDemandAuthenticationProvider {
...
@Parameters({"username", "key", "os", "browser", "browserVersion"})
 ...
 DesiredCapabilities desiredCapabilities = new DesiredCapabilities();
	...
	driver.findElement(By.id("register_email")).sendKeys("icreativeapp@gmail.com");
	driver.findElement(By.id("register_gender_male")).click();
	driver.findElement(By.id("reg-send")).click();
	wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("a.clearfix.fb-login-link")));
	String alreadyexists="This customer email already exists. Try to login";
	Assert.assertEquals(driver.findElement(By.cssSelector("ul.error-message-list")).getText(), alreadyexists);
