...
public class RegisterWithValidEmail implements SauceOnDemandSessionIdProvider, SauceOnDemandAuthenticationProvider {
...
@Parameters({"username", "key", "os", "browser", "browserVersion"})
 ...
 DesiredCapabilities desiredCapabilities = new DesiredCapabilities();
	...
	driver.findElement(By.id("register_email")).sendKeys(newemail);
	...
	Assert.assertEquals(driver.findElement(By.id("username_link")).getText(), newusername);
