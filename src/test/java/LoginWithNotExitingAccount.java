...
public class LoginWithNotExitingAccount implements SauceOnDemandSessionIdProvider, SauceOnDemandAuthenticationProvider {
...
driver.get("http://markavip.com");
	...
	driver.findElement(By.id("login_email")).sendKeys("icreativeapp1@gmail.com");
	...
	wait.until(ExpectedConditions.visibilityOfElementLocated(By.className("fb-login-section")));
	String notexistaccount="Invalid login or password.";
	
		
	System.out.println(driver.findElement(By.cssSelector("ul.error-message-list")).getText());
	Assert.assertEquals(driver.findElement(By.cssSelector("ul.error-message-list")).getText(), notexistaccount);
