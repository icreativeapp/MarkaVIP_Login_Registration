...
public class LoginWithInvalidPassword implements SauceOnDemandSessionIdProvider, SauceOnDemandAuthenticationProvider {
...
@Parameters({"username", "key", "os", "browser", "browserVersion"})
 ...
 DesiredCapabilities desiredCapabilities = new DesiredCapabilities();
	...
	String invalidpassword="Please enter 6 or more characters. Leading or trailing spaces will be ignored.";
	driver.findElement(By.id("advice-validate-password-pass")).getText();
	Assert.assertEquals(driver.findElement(By.id("advice-validate-password-pass")).getText(), invalidpassword);
    }
